...
use lib qw(/Users/heshamelabd/meme/lib/meme-5.1.1/perl);
...
unless ($@) {
  Log::Log4perl::init('/Users/heshamelabd/meme/share/meme-5.1.1/logging.conf');
  $logger = Log::Log4perl->get_logger('meme.service.utils');
}

my $service_invocation_log_dir = '/Users/heshamelabd/meme/var/meme-5.1.1/LOGS';
my $tmpdir = '';
...
sub update_status {
  ...
  my $template = HTML::Template->new(filename => '/Users/heshamelabd/meme/share/meme-5.1.1/job_status.tmpl');
