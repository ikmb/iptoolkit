...
class Proband: 
    def __init__(self,**info)->Proband:
        """
        @brief initialize a Proband using information provided in the initalizer 
        @param info an arbitatry number of key-value pair containing information about the proband
        """
